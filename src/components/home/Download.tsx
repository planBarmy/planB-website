    ...
    subtitle: (
      <>
        <a 
          ...
          className="text-3xl md:text-4xl font-bold text-[#FF6B00] hover:text-[#FF4D00] transition-colors"
        >
    ...
    <div className="py-20 px-4 bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center space-y-8">
          <p className="text-xl dark:text-white/60 text-black/60 max-w-3xl mx-auto">
            {t.subtitle}
          </p>
        </div>
      </div>
